  ...
  >
    ...
    <div class="mb-3 grid grid-cols-1 md:grid-cols-2 gap-3">
      <div>
        ...
        <select [(ngModel)]="category" class="mt-1 w-full p-2 rounded border border-white/20 bg-[#0a0a0a] text-white focus:outline-none focus:border-[#4eda2c] focus:ring-[#4eda2c]">
      ...
      <div>
        ...
        <select [(ngModel)]="condition" class="mt-1 w-full p-2 rounded border border-white/20 bg-[#0a0a0a] text-white focus:outline-none focus:border-[#4eda2c] focus:ring-[#4eda2c]">
    ...
    <div class="mb-3">
      ...
      <input [(ngModel)]="location" type="text" class="mt-1 w-full p-2 rounded border border-white/20 bg-[#0a0a0a] text-white focus:outline-none focus:border-[#4eda2c] focus:ring-[#4eda2c]" />
    </div>

    
    <div class="mb-3">
      <label class="block text-sm font-medium">Note</label>
      <textarea [(ngModel)]="note" rows="2" class="mt-1 w-full p-2 rounded border border-white/20 bg-[#0a0a0a] text-white focus:outline-none focus:border-[#4eda2c] focus:ring-[#4eda2c]"></textarea>
    </div>

    
    <div class="mb-4">
      <label class="block text-sm font-medium">Purchase Date</label>
      <input [(ngModel)]="purchaseDate" type="date" class="mt-1 w-full p-2 rounded border border-white/20 bg-[#0a0a0a] text-white focus:outline-none focus:border-[#4eda2c] focus:ring-[#4eda2c]" />
    </div>
